<script>
  ...
  export default {
    ...
    created() {
      store.commit("setBackground", Math.floor(Math.random() * 6))
...
<template>
  <div class="flex flex-col justify-center items-center h-[100dvh] w-[100vw]">
    ...
    <h1 class="text-black font-medium text-3xl uppercase">Ожидание игроков</h1>
  </div>
</template>